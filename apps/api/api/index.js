...
var TimelineSchema = z.object({ "title": z.string().describe("[CONTENT/E2E-hole]").optional(), "tz": z.string().describe("IANA timezone, author-stamped; anchors the day-boundary + NOW line"), "stops": z.array(z.any()).min(1) }).strict();
...
var ATTACH_KINDS = /* @__PURE__ */ new Set(["call", "nav", "link", "open"]);
